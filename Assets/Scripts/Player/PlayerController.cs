...
namespace MalgarHotel.Player
{
    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        private void EmitFootstepNoise()
        {
            ...
            {
                finalIntensity *= NoiseSystem.Instance.GetSurfaceMultiplier(surface);
            }
            ...
            if (NoiseSystem.Instance != null)
            {
                NoiseSystem.Instance.EmitNoise(origin, Mathf.Clamp01(finalIntensity), 0, 0.75f, NoiseTag.Footstep);
            }
        }
