...
namespace MalgarHotel.World
{
    public class FusePanelMiniGame : MonoBehaviour, IInteractable
    {
        ...
        private void Fail()
        {
            ...
            Noise.EmitNoise(transform.position, 0.85f, 2, 1f, NoiseTag.MiniGameFail);
        }
        ...
        {
            if (GameManager.Instance != null && GameManager.Instance.SfxGroup != null && feedbackAudio != null)
            {
                feedbackAudio.outputAudioMixerGroup = GameManager.Instance.SfxGroup;
            }
        }
    }
}
