...
namespace MalgarHotel.World
{
    public class ProceduralCorridorGenerator : MonoBehaviour
    {
        ...
        {
            CreateFloor(parent, new Vector3(definition.width, 0.2f, definition.length), new Vector3(0f, -0.1f, definition.length * 0.5f));
        ...
        {
            CreateFloor(parent, new Vector3(definition.width, 0.2f, definition.length), new Vector3(0f, -0.1f, definition.length * 0.5f));
            GameObject secondary = CreateFloor(parent, new Vector3(definition.width, 0.2f, definition.length), new Vector3(definition.length * 0.5f, -0.1f, definition.length), Quaternion.Euler(0f, 90f, 0f));
        ...
        private void BuildRoom(Transform parent, TileDefinition definition)
        {
            ...
            CreateFloor(parent, new Vector3(size, 0.2f, size), new Vector3(0f, -0.1f, size * 0.5f));
        }

        private GameObject CreateFloor(Transform parent, Vector3 scale, Vector3 localPos, Quaternion? rotation = null)
        {
